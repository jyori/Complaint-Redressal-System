...
{
	if (isset($_POST['comp_deptt']))
	{
		$data = json_decode(exec('super_user.py 7 '.$sess_id.' '.$_POST['comp_deptt']), true);
				...
				<div class="box alt container" style="margin: 0%; width: 100%; height: 100%;">
                        <section>
                                ...
                                <div class="table-wrapper">
                                	<form method = "POST" action "compfromdep.php">
                                    <input type="text" id="myInput" name = "comp_deptt" title="Type in a CPF Number" placeholder = 
                                    "ID to be searched">
                                </form>
