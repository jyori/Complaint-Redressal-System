...
function value($sess_id)
{
    if (isset($_POST['cpf']))
    {
        $val = 'super_user.py 5 '.$sess_id.' '.$_POST['cpf'];
                    echo ("<html>
        <script type = 'text/javascript'>
        alert($val])
        </script>
        </html>");
        $data = json_decode(exec('super_user.py 5 '.$sess_id.' '.$_POST['cpf']), true);
                ...
                <div class="box alt container" style="margin: 0%; width: 100%; height: 100%;">
                        <section>
                                ...
                                <div class="table-wrapper">
                                    <form method = "POST" action "compcpf.php">
                                    <input type="text" id="myInput" name = "cpf" title="Type in a CPF Number" placeholder = 
                                    "CPF to be searched">
                                </form>
