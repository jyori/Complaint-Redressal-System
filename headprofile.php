					...
					<section>
						...
						<div class="col-12">
                            <ul>
                                ...
                                <li>
                                	<a href="compstatus.php" style="color: #a41d23; border-bottom: 0px">
                                    <button type="button" style="width: 100%; margin-bottom: 30px">
                                        CHECK STATUS OF DEPARTMENT COMPLAINTS
                                    </button></a>
                                </li>
                                <li>
                                	<a href="approve.php" style="color: #a41d23; border-bottom: 0px">
                                    <button type="button" style="width: 100%; margin-bottom: 30px">
                                        PENDING COMPLAINTS
                                    </button></a>
                                </li>
                                <li>
                                	<a href="incoming.php" style="color: #a41d23; border-bottom: 0px">
                                    <button type="button" style="width: 100%; margin-bottom: 30px">
                                        INCOMING COMPLAINTS
                                    </button></a>
                                </li>
